...
if __name__ == '__main__':
    ...
    #THINGS PLANING TO ADD IN THIS
#VADER {POSITIVE, NEGATIVE, AND NEUTRAL}
#ENCHANCE QUERY QUESTIONING AND ALSO ADDING REPLY FROM ASHY
#DESKTOP WIDGET OR APP
#make ASHY for mobile